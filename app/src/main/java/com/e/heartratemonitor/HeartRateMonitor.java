package com.e.heartratemonitor;
...
public class HeartRateMonitor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK, "myapp:mywakelogtag");
    ...
    private static android.hardware.Camera.Size getSmallestPreviewSize(int width, int height, android.hardware.Camera.Parameters parameters) {
